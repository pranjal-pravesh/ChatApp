  ...
  return (
    <Stack
      sx={{
        ...
        backgroundColor: theme === "light" ? "rgb(238, 238, 238)" : "black",
        flexShrink: "0",
        transition: "background-color 200ms",
        display:sidebarVisibility?null:'none',
      }}
    >
      <div>
        {sidebarIcons.map((item) => {
          ...
          if (selected === item.name) {
            return (
              <Link to={item.link} replace="true">
                <Box
                  sx={{
        ...
        <Divider
          sx={{
            width: "40px",
            background: prop.theme === "light" ? "black" : "white",
          }}
        />
